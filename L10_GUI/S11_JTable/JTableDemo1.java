 ...
 * @author NGHIA NGUYEN
 */
public class JTableDemo1 extends javax.swing.JFrame {
    ...
    public JTableDemo1() {
        initComponents();
         ...
         /**
         * create a new model, then alternate it to the existing model
         *      cannot keep the properties of current table model
         */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JTableDemo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JTableDemo1().setVisible(true);
            }
        });
    }
